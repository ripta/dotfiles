...
plugins=(docker encode64 fancy-ctrl-z jsontools kubectl osx redis-cli sprunge ssh-agent rvm bundler brew aws z)
plugins+=(bd direnv fleetctl gogo kube-context rpasay-git)
